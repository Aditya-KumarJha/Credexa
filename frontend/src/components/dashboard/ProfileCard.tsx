import { User, Mail, WalletCards, Phone, AtSign, FileText, ExternalLink } from "lucide-react";
  ...
  return (
    <div className="p-8 rounded-2xl shadow-lg mb-10 border border-emerald-100 dark:border-emerald-800 bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        {user?.resume && (
          <div className="flex items-center">
            <FileText className="h-6 w-6 mr-3 text-cyan-500" />
            <div>
              ...
              <a 
                ...
                className="font-medium text-cyan-600 hover:text-cyan-700 flex items-center gap-1"
              >
                {user.resume.fileName} <ExternalLink className="h-3 w-3" />
              </a>
            </div>
          </div>
        )}
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            ...
            {user.socialLinks.github && (
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="flex items-center gap-2 text-sm text-gray-800 dark:text-gray-200 hover:text-gray-600 dark:hover:text-gray-400 hover:underline"
              >
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            {user.socialLinks.twitter && (
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="flex items-center gap-2 text-sm text-gray-800 dark:text-white hover:text-gray-600 dark:hover:text-gray-300 hover:underline"
              >
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
