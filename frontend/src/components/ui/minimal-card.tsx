...
>(({ className, children, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "group rounded-[24px] bg-neutral-50 p-2 no-underline shadow-sm transition-colors dark:bg-neutral-800",
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn(
      "mt-2 px-1 text-lg font-semibold leading-tight text-gray-300 transition-colors dark:text-neutral-50",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <p
    ref={ref}
    className={cn(
      "px-1 pb-2 mt-4 text-sm text-gray-300 transition-colors dark:text-neutral-400",
      className
    )}
    {...props}
  />
